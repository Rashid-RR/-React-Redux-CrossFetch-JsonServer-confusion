...
import {Breadcrumb,BreadcrumbItem,Col,Input,Label, Button,Row, CarouselControl} from 'reactstrap'
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        messages={{
                                            ...
                                            maxLength : 'Your Name should be less than 3 '
                                        }}
                                     />
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        messages={{
                                            required:'Required ',
                                            minLength:'Your Last Name should be atleast 2 characters long ',
                                            maxLength:'Your Last Name must be less than 3 characters '
                                        }}
                                     />    
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        messages={{
                                            required:'Required ',
                                            minLength : 'Your Namber should be atleast 3 greaters long ',
                                            maxLength : 'Your Number must be less than 15 ',
                                            isNumber:'You only write Numbers in this field '
                                        }}
                                     />
                                </Col>
                            </Row>
